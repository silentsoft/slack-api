...
public class NoticeFileTest {
	...
	public void noticeFileTest() throws Exception {
		String markdown = generateSlackAPINoticeMarkdown();
	...
	private String generateSlackAPINoticeMarkdown() {
		return NoticeFileGenerator.newInstance("Slack API", "silentsoft.org")
